                ...
                <asp:GridView ID="dgv" runat="server" CssClass="EU_DataTable" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%">  
                           <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Date of Birth">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPhone" Text='<%# Eval("User_DOB") %>' runat="server"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                               <asp:TemplateField HeaderText="Enroll Date">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtGender" Text='<%# Eval("EnrollDate") %>' runat="server"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Present Station">
                                        <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Age Limit">
                                        <ItemTemplate>
                                            <asp:Label Text='<%# Eval("AgeLimit") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtMariStatus1" Text='<%# Eval("AgeLimit") %>' runat="server"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                    </Columns>  
