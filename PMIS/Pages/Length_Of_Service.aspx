<%@ Page Title="Length Of Service" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Length_Of_Service.aspx.cs" Inherits="PMIS.Pages.Dependent" %>
                ...
                <asp:GridView ID="dgv" runat="server" CssClass="EU_DataTable" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%">  
                           <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Enroll Date">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPhone" Text='<%# Eval("EnrollDate") %>' runat="server"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                               ...
                               <asp:TemplateField HeaderText="Years Served">
                                        <ItemTemplate>
                                            <asp:Label Text='<%# Eval("YEARS_SERVED") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtMariStatus1" Text='<%# Eval("YEARS_SERVED") %>' runat="server"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                    </Columns>  
