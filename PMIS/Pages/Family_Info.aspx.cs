            ...
            try
            {
                if (Session["Role"].ToString() == "User")
                {
                    query = "Insert into tbl_FamilyInfo (User_ID,Fa_Name,Fa_CNIC,Fa_Nationality,Fa_Occupation,Fa_Religion,Fa_Alive,Fa_Phone,Fa_Address, " +
                        ...
                        "Ml_Alive,Is_Deleted,Created_On,Created_By,Pno,Status) " +
                        ...
                        " '" + txtM_inLaw.Text + "', '" + txtM_inLawOcc.Text + "', '" + txtM_inlawadd.Text + "', '" + txtM_inLawAlive.Text + "', '" + false + "', getDate() ,'" + Session["Name"].ToString() + "','" + Session["User_Pno"].ToString() + "','Pending')";
